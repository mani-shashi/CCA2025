...
char vow = 'w';
Console.WriteLine($"{vow} is vowel: {v.IsVowel(vow)}");
...
AdmissionEligibilityChecker Adm = new AdmissionEligibilityChecker();

ELectricityBillCalculator El = new ELectricityBillCalculator();
double units = 92;
Console.WriteLine($"Electricity bill of {units} units: {El.CalculateBill(units)}");
